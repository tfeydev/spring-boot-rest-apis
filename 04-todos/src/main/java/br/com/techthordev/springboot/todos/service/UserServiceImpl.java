...
import br.com.techthordev.springboot.todos.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
	...
	public void updatePassword(PasswordUpdateRequest passwordUpdateRequest) {
		...
		if (!isOldPasswordCorrect(user.getPassword(), passwordUpdateRequest.getOldPassword())) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Current passowrd is incorrect.");
		}
